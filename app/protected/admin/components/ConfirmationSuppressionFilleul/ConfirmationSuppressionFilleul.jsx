    ...
    return (
        ...
        >
            <DialogTitle sx={{ textAlign: 'center' }} id="responsive-dialog-title">
                {"Êtes-vous sur de vouloir supprimer ce filleul ?"}
            </DialogTitle>
            <DialogContent>
                <DialogContentText sx={{ textAlign: 'center' }}>
                    La suppression de ce filleul entrainera la suppression de toutes les <strong>commissions</strong> qui lui sont directement <strong>rattaché</strong>
                </DialogContentText>
            </DialogContent>
            <DialogActions>
