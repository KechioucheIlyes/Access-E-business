        ...
        >
            ...
            <DialogContent>
                <DialogContentText sx={{ textAlign: 'center' }}>
                    La suppression de ce client entrainera la suppression de toutes les <strong>études</strong> et tout les <strong>dirigeants</strong> qui lui sont directement <strong>rattaché</strong>
                </DialogContentText>
            </DialogContent>
            <DialogActions>
