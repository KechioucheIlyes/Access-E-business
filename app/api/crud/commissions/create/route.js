...
/**
 * @swagger
 * /api/crud/commissions/create:
 *   post:
 *     summary: Créer une nouvelle commission
 *     description: Crée une nouvelle commission avec les informations fournies.
 *     tags: [Commission]  # Si vous avez une section spécifique pour les commissions
 *     requestBody:
 *       description: Données de la commission à créer
 *       required: true
 *       content:
 *         application/json:
 *           schema:
 ...
 *       500:
 *         description: Erreur serveur lors de la création de la commission.
 *         content:
 *           application/json:
 *             example:
 *               message: Échec lors de la création de la commission.
*     security:
 *       - BearerAuth: []
 */
